---
title: "MIRTH.CC"
description: "A highly performant exercise in minimalism, with perfect Google Lighthouse scores to boot. ([Source code](https://github.com/lumirth/lumirth.github.io))"
pubDate: "Mar 18 2023"
updatedDate: "Mar 23 2023"
banner_source: "/mirth/city-lights.jpeg"
image_source: "/mirth/bracket-icon.svg"
...
![ANIMATION: Perfect Google Lighthouse score, four green circles with '100' inside each one, with text underneath each reading, in order: 'Performance, Accessibility, Best Practices, SEO](/mirth/perfect-lighthouse.mp4)
...
![What stevelosh.com looked like at time of writing](/mirth/stevelosh.png)
![What danluu.com looked like at time of writing](/mirth/danluu.png)
God bless these two.
:::
...
:::style{.aside .aside--left}
![ANIMATION: clip of navigating between tabs on mirth.cc on a mobile device](/mirth/teensy-mirth-nav.mp4)
Watch her go! 
:::
