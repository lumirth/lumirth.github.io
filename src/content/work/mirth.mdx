...
{/* ![Perfect Google Lighthouse score](/perfect-lighthouse.mp4) */}
...
:::style{.aside-right}
![stevelosh.com](/stevelosh.png)
![danluu.com](/danluu.png)
God bless these two.
:::
...
:::style{.aside-left}
<video autoplay loop muted webkit-playsinline playsinline title="GIF clip of navigating between tabs on mirth.cc on a mobile device">
