...
<Card 
    ...
    description="A dead-simple tool that fixes the example URLs on UIUC's CISAPI documentation page. [(On Github)](https://github.com/lumirth/fix-cisapi). "
...
<Card 
    ...
    description="A test site built as-assigned for the UIC Technologys Solution SDD internship program, built in vanilla(haha, get it?) HTML, CSS, and Javascript. [(On Github)](https://github.com/lumirth/vanillashake)."
