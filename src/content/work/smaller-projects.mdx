...
<Card 
    title="VanillaShake"
    href="https://is.gd/3Na9iT"
    description="A test site built as-assigned for the UIC Technologys Solution SDD internship program, built in vanilla(haha, get it?) HTML, CSS, and Javascript."
